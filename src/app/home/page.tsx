  ...
  return (
    loader ? <div className='h-screen w-full flex items-center justify-center text-2xl font-semibold'>Loading...</div> : <div className='overflow-hidden relative w-full bg-stone-100'>
      <div className="container mx-auto md:px-6 px-2">
        ...
        {
          userInfo?.user?.uid ? <div className="flex flex-col lg:flex-row lg:gap-3 gap-0 justify-center h-auto pb-4 mt-2">
            <div className="h-fit bg-white lg:w-[300px] w-full mt-[80px] shadow rounded px-4 py-2 overflow-x-hidden overflow-y-scroll block">
              <h2 className='text-lg py-1 font-semibold text-blue-950 border-b-2 border-b-sky-500'>Shortcut</h2>
              <Shortcut />
            </div>

            <div className="xl:w-[700px] md:w-[550px] w-full h-auto mt-2 lg:mt-[80px] md:px-3 pb-2 overflow-x-hidden overflow-y-scroll custom-scroll">
              <Feeds />
            </div>
